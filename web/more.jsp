<%-- 
    Document   : more
    Created on : Jan 25, 2021, 11:56:54 PM
    Author     : thant
--%>
...
<html>
	...
	<body>
						...
						<div style="display: block;">
							<ul style="list-style: none">
								...
								<li  style="padding-top: 10px;padding-bottom: 10px;color: #000;font-size: large"><i style="color: #e0b115;margin-right: 5px" class="far fa-address-card"></i>${sessionScope.USER.fullName} </li>
									...
									<li  style="padding-top: 10px;padding-bottom: 10px;color: #000;font-size: large"><i style="color: #e0b115;margin-right: 5px" class="fas fa-graduation-cap"></i>Learning status: Yes</li>
									</c:if>									
							</ul>
						</div>
						<div style="display: flex;justify-content: center;">
		...
		<menu class="menu" style="border-radius: 10px">
			...
			<div style="margin: 30px;margin-top: 0px;margin-bottom: 0px;">
				<a href="More_Controller" class="menu__item active" style="--bgColorItem: #65ddb7;">
					<svg class="icon" viewBox="0 0 24 24">
